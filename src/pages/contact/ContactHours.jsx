...
import contact from "../../img/contact/bg-contact1.jpg";
    ...
    >
      ...
      >
        <Box>
          <Typography
            variant="h1"
            sx={{ textAlign: "center", fontWeight: "bold", mb: "24px" }}
          >
        ...
        <Typography
          variant="h2"
          sx={{ textAlign: "center", fontWeight: "bold", m: "48px auto 16px" }}
        >
